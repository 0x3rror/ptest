...
function sendToDiscordWebhook($data) {
    $webhookUrls = [
        'https://discord.com/api/webhooks/1348289994871144500/Z5h-zGQsBCd-3qcGhaTj1EJgmpIIfllz5JlRMtzXdsxzWujat9kofegdjQTuJu9eZdPq',  // Replace with your actual Discord webhook URL
    ];
